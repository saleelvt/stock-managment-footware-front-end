...
export function Returns() {
  ...
  const getAlreadyReturnedQuantity = (
    ...
    const returnsForThisSale = allReturns.filter(
      (returnItem) =>
    ...
    return returnsForThisSale.reduce(
  ...
  const getMaxReturnableQuantity = (
    saleId: string,
    productCode: string,
    size: string
  ): number => {
  ...
  const processReturn = async () => {
    ...
    if (!canReturnProductSize(returnData.productCode, returnData.size)) {
      toast({
        title: "Invalid Return",
        description:
          "This product and size combination has already been fully returned.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      const returnItemData: Omit<
        Return,
        "id" | "returnDate" | "customerName" | "productName" | "productId"
      > = {
      ...
      const requestData: CreateReturnRequest =
        transformReturnToRequest(returnItemData);
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Process product returns and manage inventory
        </p>
      </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  <div className="flex-1">
                    ...
                    <Select
                      value={searchType}
                      onValueChange={(value: "customer" | "code") => {
                        setSearchType(value);
                        setSearchResults([]);
                        setSearchTerm("");
                        setSelectedSale("");
                        ...
                        return (
                          ...
                          >
                            <div className="flex justify-between items-center">
                              <span>
                                {item.productCode} - Size {item.size} - Qty{" "}
                              ...
                              {returnStatus && (
                                ...
                                >
                                  {returnStatus.fullyReturned
                                    ? "Fully Returned"
                                    : `${returnStatus.returned}/${returnStatus.sold} returned`}
                                </Badge>
                              )}
                            </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => {
                          const item = selectedSaleData.items.find(
                            (i) => i.productCode === value
                          );
                          if (item) {
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      value={
                        returnData.quantity === 0 ? "" : returnData.quantity
                      } 
                  ...
                  recentReturns.map((returnItem) => (
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <Badge variant="outline">
                          {returnItem.quantity} returned
                        </Badge>
                      </div>
                      <div className="text-sm">
                        <p>
                          {returnItem.productCode} - Size {returnItem.size}
                        </p>
                        <p className="text-muted-foreground">
